...
export default function Home() {
  return (
    <div className="max-h-home grid grid-cols-9 grid-rows-6 gap-6">
      <Link
        href="/"
      ...
      >
        <Image
          ...
          alt=""
        />
        <div className="max-w-product-info absolute bottom-28 right-28 flex h-12 items-center gap-2 rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
      ...
      >
        <Image
          ...
          alt=""
        />
        <div className="max-w-product-info absolute bottom-10 right-10 flex h-12 items-center gap-2 rounded-full border-2 border-zinc-500 bg-black/60 p-1 pl-5">
